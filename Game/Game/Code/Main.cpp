...
int main()
{
	...
	engine.addObject(new Conductor(LINE1_BEGIN, BG_VELOCITY, 1000, sf::Sprite(*(texturesMap["Conductor"])), 4));
	engine.addObject(new Hero(Vector(50, LINE3_BEGIN.GetY()), Vector(0,0), 1000, sf::Sprite(*(texturesMap["Hero"])), 4));
